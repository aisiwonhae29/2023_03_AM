...
public class Main {
	...
	public static void makeTestData() {
		...
		articles.add(new Article(1, Util.getNowDateTimeStr(), Util.getNowDateTimeStr(), "삼국지", "이야기"));
		articles.add(new Article(2, Util.getNowDateTimeStr(), Util.getNowDateTimeStr(), "삼국지", "이야기"));
		articles.add(new Article(3, Util.getNowDateTimeStr(), Util.getNowDateTimeStr(), "삼국지", "이야기"));
